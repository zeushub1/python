...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠛⢿⣿⣿⣿⣿
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⣿⣿⣿  \n"
{white}HİT : {green}{hits} {white}Kötü İnsta: {red}{badinsta} {white}Kötü Mail: {yellow} {bademail} {white}İyi İnsta: {orange}{goodig} {cyan}
\n{yellow}@Warxels ~ @QueryTool""")
...
╔══════════════════════════════════════════════╗
║{cyan} -> 𝟭.   𝟮𝟬𝟭𝟬 - 𝟮𝟬𝟭𝟭{reset}                          
║{cyan} -> 𝟮.   𝟮𝟬𝟭𝟮 - 𝟮𝟬𝟭𝟯{reset}                          
║{cyan} -> 𝟯.   𝟮𝟬𝟭𝟰 - 𝟮𝟬𝟭𝟱{reset}                          
║{cyan} -> 𝟰.   𝟮𝟬𝟭𝟱 - 𝟮𝟬𝟭𝟲{reset}                          
║{cyan} -> 𝟱.   𝟮𝟬𝟭𝟬 - 𝟮𝟬𝟭𝟵{reset}                          
╚══════════════════════════════════════════════╝
""")
logo = input(f"{white} Seç: {reset}")
...
➥ 𝐌𝐀𝐈̇𝐋 : {username}@{gg}  
➥ 𝐑𝐄𝐒𝐄𝐓 : {rest(username)} 
➥𝐔𝐑𝐋 : https://instagram.com/{username} 
