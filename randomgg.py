...
print(Fore.RESET + "_" * 67)
warxels = pyfiglet.figlet_format("IG Meta Tool", font="slant")
print(Fore.CYAN + Style.BRIGHT + warxels + Style.RESET_ALL)           
print(Fore.RESET + "_" * 67)
...
def Woltex():
    try:
        ...
        tok = re.search(
            'data-initial-setup-data="%.@.null,null,null,null,null,null,null,null,null,&quot;(.*?)&quot;,null,null,null,&quot;(.*?)&',            res1.text
        ).group(2)
    ...
    try:
        ...
        data = {
            SIGNED_BODY: ('0d067c2f86cac2c17d655631c9cec2402012fb0a329bcafb3b1f4c0bb56b1f1f.'
                          ...
                          '"device_id":"android-b93ddb37e983481c",'                          '"query":"' + user + '"}'),
            IG_SIG_KEY_VERSION: '4'
        }
    ...
    while True:
        data = {
            ...
            'variables': json.dumps({
                'id': int(random.randrange(266028916, 1900000000)),                'render_surface': 'PROFILE'
            }),
